...
data_path = 'Panel_Alp_1_Cellulate' # 'Spatial_Coupling_3D_AI_Earth_0_N_G_FL'
acts = [0] # [0, 1, ...]
act = max(acts)
_observe = 0 # {0, 1, ...}
observe = _observe if act != 0 else None
curb = (5, 3) # Cellulate # {0: (5, 3), 1: (10, 4, 2), 2: (15, 5, 3, 1)}
...
def construct_stem(parameter_set, parameter_set_true, para_fun, sup_comp = False, verbose = False):
    ...
    jump_diffuse = { # Two-Step Process? # V ~ Void
        ...
        'deltas': [{'FC': -1}, {'FC': -1}, {'FC': -1}, {'FC': -1}, {'FM': -1}, {'FM': -1}, {'FM': -1}, {'FM': -1}, {'FL': -1}, {'FS_UP': -1}, {'FS_DO': -1}],
        'jump_diffuse_deltas': [{'FM': 1}, {'FL': 1}, {'FS_UP': 1}, {'FS_DO': 1}, {'FM': 1}, {'FL': 1}, {'FS_UP': 1}, {'FS_DO': 1}, {'FM': 1}, {'FM': 1}, {'FM': 1}],
        ...
        'initial_state': {'FC': 0, 'FM': 0, 'FL': 0, 'FS_UP': 0, 'FS_DO': 0}
    }
    ...
    dimerization = { # FD has no direct degradation, but we put it at the end!
        ...
        'rates': {'kdf_FD': 1/para_fun('tau_df_FD'), 'kdb_FD': 1/para_fun('tau_db_FD')},
        'initial_state': {'FD': 0}
    }
...
para_set_raw = {
    'N_N': (125, (0, 1000)), 'G_G': (275, (0, 1000)), 'FC_N': (552, (0, 1000)), 'G_EA': (615, (0, 1000)),
    'G_N': (412, (0, 1000)), 'N_G': (411, (0, 1000)), 'FC_G': (95, (0, 1000)), 'N_EA': (695, (0, 1000)),
    'MRNA': (117, (0, 250)), 'PRO': (482, (0, 1000)),
    'td_FC': (13158, (300, 28800)), 'td_FM': (3456, (300, 28800)), 'td_FL': (13158, (300, 28800)), 'td_FS': (3456, (300, 28800)),
    'tau_C': (2303, (300, 45000)), 'tau_M': (1380, (300, 42000)), 'tau_L': (2303, (30, 450000)), 'tau_S': (1380, (30, 420000)),
    'tau_df_FD': (100000, (300, 345600)), 'tau_db_FD': (360, (30, 345600)),
    'tau_ef_EA': (31379, (300, 43200)), 'tau_eb_EA': (1025, (30, 43200)), 'tau_pf_NP': (18944, (300, 43200)), 'tau_pb_NP': (21361, (30, 43200)),
    'chi_auto': (0.39, (0, 1))
}
...
def simulator(parameter_set, parameter_set_true, parameter_set_mode, species = ['N', 'G', 'NP'], steps = 10000, cells = 3, cellulate = (2, 1), time_mini = 0, time_maxi = 48, time_unit = 'Hours', time_delta = 0.2, cell_layers = 2, layer_cells = 1, faces = 2*3, seed = None, sup_comp = False, verbose = False):
    ...
    state_tor_PRE = {'N': 0, 'G': 0, 'N_MRNA': 0, 'G_MRNA': 0, 'NP': 0, 'FC': 0, 'FC_MRNA': 0, 'FM': 0, 'FD': 0, 'FL': 0, 'FS_UP': 0, 'FS_DO': 0, 'EI': 1000, 'EA': 0}
    state_tor_EPI = {'N': 0, 'G': 0, 'N_MRNA': 0, 'G_MRNA': 0, 'NP': 0, 'FC': 0, 'FC_MRNA': 0, 'FM': 0, 'FD': 0, 'FL': 0, 'FS_UP': 0, 'FS_DO': 0, 'EI': 1000, 'EA': 0}
    state_tor_V = {'N': 0, 'G': 0, 'N_MRNA': 0, 'G_MRNA': 0, 'NP': 0, 'FC': 0, 'FC_MRNA': 0, 'FM': 0, 'FD': 0, 'FL': 0, 'FS_UP': 0, 'FS_DO': 0, 'EI': 0, 'EA': 0}
    ...
    kd_FS_UP = 1/para_fun('td_FS')
    kd_FS_DO = 1/para_fun('td_FS')
...
steps = 10000000 if sup_comp else 5000000
...
arguments = (parameter_set, parameter_set_true, parameter_set_mode, species, steps, cells, cellulate, time_mini, time_maxi, time_unit, time_delta, cell_layers, layer_cells, faces, seed, sup_comp, verbose)
