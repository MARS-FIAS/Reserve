    ...
    for task in range(tasks):
        ...
        for exploration in range(task_explorations):
            if exploration == 0:
                ...
                objective_fun = ObjectiveFunPortionRule(trajectory_set, species, time_mini, time_maxi, time_unit, time_delta, simulations_maxi = 10, verbose = verbose, show = show, rules = parameter_set_rules, aim_NT = [2/5], aim_G = [3/5], L = _observe)
