...
data_path = 'Shallow_Grid_1_N_Lock'
act = 0 # [0, 1, ...]
_observe = 0 # {0, 1, ...}
...
def simulator(parameter_set, parameter_set_true, parameter_set_mode, parameter_set_rules = None, species = ['N', 'G', 'N_MRNA', 'G_MRNA', 'NP', 'FC', 'FC_MRNA', 'FM', 'FD', 'EI', 'EA'], steps = 10000, cells = 3, time_mini = 0, time_maxi = 48, time_unit = 'Hours', time_delta = 0.2, cell_layers = 2, layer_cells = 1, faces = 2*3, seed = None, jump_diffuse_seed = 0, sup_comp = False, verbose = False):
...
arguments = (parameter_set, parameter_set_true, parameter_set_mode, parameter_set_rules, species, steps, cells, time_mini, time_maxi, time_unit, time_delta, cell_layers, layer_cells, faces, seed, jump_diffuse_seed, sup_comp, verbose)
...
from ObjectiveFun import ObjectiveFunPortionRule
...
if inference_prod_activate:
    ...
    for train_trial in range(train_trials):
        # Preparation
        objective_fun_reference = ObjectiveFunPortionRule(trajectory_set, species, time_mini, time_maxi, time_unit, time_delta, simulations_maxi = 10, verbose = False, show = False, rules = parameter_set_rules)
        ...
        # Synthetic Data
        objective_fun = ObjectiveFunPortionRule(None, species, time_mini, time_maxi, time_unit, time_delta, simulations_maxi = 10, verbose = False, show = False, rules = parameter_set_rules)
