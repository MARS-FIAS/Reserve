...
para_set_raw = {'FL': (750, (0, 15000)), 'tau_M': (450, (30, 2100)), 'tau_L': (450, (30, 900)), 'tau_S_UP': (450, (30, 2100)), 'tau_S_DO': (450, (30, 2100))}
para_set_mode = 1 # {0, 1}
...
def simulator(parameter_set, parameter_set_true, parameter_set_mode, species = ['N', 'G', 'N_MRNA', 'G_MRNA', 'NP', 'FD', 'EA'], steps = 10000, cells = 3, time_mini = 0, time_maxi = 48, time_unit = 'Hours', time_delta = 0.2, cell_layers = 2, layer_cells = 1, faces = 2*3, seed = None, jump_diffuse_seed = 0, sup_comp = False, verbose = False):
    ...
    ksig_S_UP = 1/para_fun('tau_S_UP')
    ksig_S_DO = 1/para_fun('tau_S_DO')
    rate_mat = instate_rate_mat(stem, cells, parameter_set, parameter_set_true, para_fun, rates_exclude, rho_mat, sigma_vet, blank = False, ksig_M = ksig_M, ksig_L = ksig_L, ksig_S_UP = ksig_S_UP, ksig_S_DO = ksig_S_DO)
...
if not sup_comp:
    tasks = 2
    task_simulations = 5
    path = '/media/mars-fias/MARS/MARS_Data_Bank/Art_Intel/Spatial_Coupling_3D_AI_Twin_1/'
...
if sup_comp:
    ...
    path = '/scratch/biochemsim/ramirez/mars_projects/spatial_coupling_art_intel/data_bank/Spatial_Coupling_3D_AI_Twin_1/'
