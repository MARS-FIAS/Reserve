...
para_set, para_set_true = make_paras(P_B = (0, 1000), exclude = ['Initial_Pat'], verbose = True)
...
if not sup_comp:
    tasks = 2
    task_simulations = 5
    path = '/media/mars-fias/MARS/MARS_Data_Bank/Art_Intel/Spatial_Coupling_3D_AI_2/'
    tag = 'Loa_Comp'
    safe = True
...
if sup_comp:
    task = int(sys.argv[1])
    task_simulations = 10
    path = '/scratch/biochemsim/ramirez/mars_projects/spatial_coupling_art_intel/data_bank/Spatial_Coupling_3D_AI_2/'
    tag = 'Sup_Comp'
    safe = True
