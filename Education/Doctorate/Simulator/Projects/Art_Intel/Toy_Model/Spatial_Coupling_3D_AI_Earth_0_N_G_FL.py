...
data_path = 'Spatial_Coupling_3D_AI_Earth_0_N_G_FL' # {'Spatial_Coupling_3D_AI_All_1_Relax', 'Spatial_Coupling_3D_AI_All_0'}
act = 0 # [0, 1, ...]
_observe = 0 # {0, 1, ...}
...
para_set_raw = {
    ...
    'N_MRNA': (50, (0, 250)), 'G_MRNA': (50, (0, 250)), 'N': (200, (0, 1000)), 'G': (200, (0, 1000)), 'FL': (1000, (0, 15000)),
...
if inference_prod_activate:
    ...
    for train_trial in range(train_trials):
        # Preparation
        objective_fun_reference = ObjectiveFunTwo(trajectory_set, species, time_mini, time_maxi, time_unit, time_delta, simulations_maxi = 10, verbose = False, show = False, alpha = 1)
        ...
        # Synthetic Data
        objective_fun = ObjectiveFunTwo(None, species, time_mini, time_maxi, time_unit, time_delta, simulations_maxi = 10, verbose = False, show = False, alpha = 1)
