...
class BiochemSimulMuleRapid:
    ...
    def _meth_direct(self):
        ...
        if '_meth_direct' not in globals():
            ...
            @numba.njit
            def __meth_direct__(steps, cells, step_cells, stream_epoch, stream_alps, epoch_mat, pre, state_tor, ran_tor, rate_mat, indices, delta_mat, jump_diffuse_vet, jump_diffuse_comm_classes, jump_diffuse_tor, jump_diffuse_delta_mat, epoch_halt):
    ...
    def meth_direct(self, jump_diffuse_tor = None, epoch_halt_tup = (None, None)):
        ...
        # Epoch Halt [Final]
        #
        self.epoch_mat, self.state_tor, self.step_cells = _meth_direct(self.steps, self.cells, step_cells, stream_epoch, stream_alps, epoch_mat, pre, state_tor, ran_tor, rate_mat, indices, delta_mat, jump_diffuse_vet, jump_diffuse_comm_classes, jump_diffuse_tor, jump_diffuse_delta_mat, epoch_halt)
        #
        return self
