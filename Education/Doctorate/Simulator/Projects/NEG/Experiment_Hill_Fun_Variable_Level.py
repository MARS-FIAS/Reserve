####################################################
########                                    ########
######## Experiment Hill Fun Variable Level ########
########                                    ########
####################################################
...
file = open(f'{path}/Ex_Two_{seed}_{trajectories}_{steps}_{mule}', 'rb')
exec(f'dit = pickle.load(file)')
file.close()

file = open(f'{path}/Ex_Two_Time_{seed}_{trajectories}_{steps}_{mule}', 'rb')
