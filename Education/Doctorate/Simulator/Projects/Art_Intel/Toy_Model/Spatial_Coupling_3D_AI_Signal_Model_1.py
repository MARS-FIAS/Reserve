...
include = {'FV': (750, (0, 15000)), 'tau_void': (45, (30, 900)), 'tau_men': (900, (30, 2100))}
...
def simulator(parameter_set, parameter_set_true, species = ['N', 'G', 'N_MRNA', 'G_MRNA', 'NP', 'FED', 'EA'], steps = 10000, cells = 3, time_mini = 0, time_maxi = 48, time_unit = 'Hours', time_delta = 0.2, cell_layers = 2, layer_cells = 1, faces = 2*3, seed = None, jump_diffuse_seed = 0, sup_comp = False, verbose = False):
    ...
    state_tor_PRE = {'N': 0, 'G': 0, 'N_MRNA': 0, 'G_MRNA': 0, 'NP': 0, 'FED': 0, 'EA': 0, 'EI': 1000, 'FI': 0, 'FI_MRNA': 0, 'FE': 0, 'FV': 0, 'FS': 0}
    state_tor_EPI = {'N': 0, 'G': 0, 'N_MRNA': 0, 'G_MRNA': 0, 'NP': 0, 'FED': 0, 'EA': 0, 'EI': 1000, 'FI': 0, 'FI_MRNA': 0, 'FE': 0, 'FV': 0, 'FS': 0}
    state_tor_V = {'N': 0, 'G': 0, 'N_MRNA': 0, 'G_MRNA': 0, 'NP': 0, 'FED': 0, 'EA': 0, 'EI': 0, 'FI': 0, 'FI_MRNA': 0, 'FE': 0, 'FV': para_fun('FV'), 'FS': 0}
...
if not sup_comp:
    tasks = 2
    task_simulations = 5
    path = '/media/mars-fias/MARS/MARS_Data_Bank/Art_Intel/Spatial_Coupling_3D_AI_Signal_Model_1/'
...
if sup_comp:
    ...
    path = '/scratch/biochemsim/ramirez/mars_projects/spatial_coupling_art_intel/data_bank/Spatial_Coupling_3D_AI_Signal_Model_1/'
