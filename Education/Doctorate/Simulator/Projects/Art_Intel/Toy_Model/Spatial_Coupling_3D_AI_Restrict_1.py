...
curb = 'FeedBack-Off' # {'FeedBack-Off', 'Weak-Interact'}
restrict = {
    'FeedBack-Off': {'N_N': 1000, 'G_G': 1000, 'FI_N': 1000, 'G_EA': 2000, 'G_N': 1000, 'N_G': 1000, 'FI_G': 1000, 'N_EA': 2000},
    'Weak-Interact': {'N_N': 2000, 'G_G': 2000, 'FI_N': 2000, 'G_EA': 2000, 'G_N': 2000, 'N_G': 2000, 'FI_G': 2000, 'N_EA': 2000}
}
...
if not sup_comp:
    tasks = 2
    task_simulations = 5
    path = '/media/mars-fias/MARS/MARS_Data_Bank/Art_Intel/Spatial_Coupling_3D_AI_Restrict_1/'
...
if sup_comp:
    ...
    path = '/scratch/biochemsim/ramirez/mars_projects/spatial_coupling_art_intel/data_bank/Spatial_Coupling_3D_AI_Restrict_1/'
