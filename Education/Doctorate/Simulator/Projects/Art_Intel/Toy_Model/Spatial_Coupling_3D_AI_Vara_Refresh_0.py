...
vara = 1000 # {500, 750, 1000, 1250, 1500, 2000, 3000}
refresh = 400 # Careful Usage! The function 'construct_stem' utilizes it indirectly!
...
para_set, para_set_true = make_paras(P_B = (0, vara), exclude = ['Initial_Pat', 'G_G', 'FI_N', 'G_EA', 'FI_G', 'N_EA'], verbose = True)
...
if not sup_comp:
    tasks = 2
    task_simulations = 5
    path = '/media/mars-fias/MARS/MARS_Data_Bank/Art_Intel/Spatial_Coupling_3D_AI_Vara_Refresh_0/'
    tag = f'Loa_Comp_{vara}_{refresh}'
    safe = True
...
if sup_comp:
    ...
    path = '/scratch/biochemsim/ramirez/mars_projects/spatial_coupling_art_intel/data_bank/Spatial_Coupling_3D_AI_Vara_Refresh_0/'
    tag = f'Sup_Comp_{vara}_{refresh}'
    safe = True
...
if not sup_comp:
    tasks = 10
    path = '/media/mars-fias/MARS/MARS_Data_Bank/Art_Intel/Spatial_Coupling_3D_AI_Vara_Refresh_0/'
    tag = f'Sup_Comp_{vara}_{refresh}' # 'Loa_Comp'
