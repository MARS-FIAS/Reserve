...
data_path = 'Shallow_Grid_1_Rule_N_G'
acts = [0] # [0, 1, ...]
act = max(acts)
...
if inference_prod_activate:
    ...
    for train_trial in range(train_trials):
        # Preparation
        objective_fun_reference = ObjectiveFunPortionRule(trajectory_set, species, time_mini, time_maxi, time_unit, time_delta, simulations_maxi = 10, verbose = False, show = False, rules = parameter_set_rules, L = _observe)
        ...
        # Synthetic Data
        objective_fun = ObjectiveFunPortionRule(None, species, time_mini, time_maxi, time_unit, time_delta, simulations_maxi = 10, verbose = False, show = False, rules = parameter_set_rules, L = _observe)
