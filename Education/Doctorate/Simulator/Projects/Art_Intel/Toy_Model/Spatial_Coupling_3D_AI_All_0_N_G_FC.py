...
data_path = 'Spatial_Coupling_3D_AI_All_0_N_G_FC'
act = 0 # [0, 1, ...]
_observe = 0 # {0, 1, ...}
...
para_set_raw = {
    ...
    'FC': (400, (0, 800)),
    'td_FM': (7200, (300, 28800)), 'td_FL': (7200, (300, 28800)), 'td_FS': (7200, (300, 28800)),
    'tau_C': (450, (30, 900)), 'tau_M': (450, (30, 2100)), 'tau_L': (450, (30, 900)), 'tau_S': (450, (30, 2100))
}
para_set_mode = 0 # {0, 1}
...
def simulator(parameter_set, parameter_set_true, parameter_set_mode, species = ['N', 'G', 'N_MRNA', 'G_MRNA', 'NP', 'FD', 'EA'], steps = 10000, cells = 3, time_mini = 0, time_maxi = 48, time_unit = 'Hours', time_delta = 0.2, cell_layers = 2, layer_cells = 1, faces = 2*3, seed = None, jump_diffuse_seed = 0, sup_comp = False, verbose = False):
    ...
    state_tor_PRE = {'N': 0, 'G': 0, 'N_MRNA': 0, 'G_MRNA': 0, 'NP': 0, 'FD': 0, 'EA': 0, 'EI': 1000, 'FC': para_fun('FC'), 'FC_MRNA': 0, 'FM': 0, 'FL': 0, 'FS_UP': 0, 'FS_DO': 0}
    state_tor_EPI = {'N': 0, 'G': 0, 'N_MRNA': 0, 'G_MRNA': 0, 'NP': 0, 'FD': 0, 'EA': 0, 'EI': 1000, 'FC': para_fun('FC'), 'FC_MRNA': 0, 'FM': 0, 'FL': 0, 'FS_UP': 0, 'FS_DO': 0}
...
if inference_prod_activate:
    ...
    for train_trial in range(train_trials):
        # Preparation
        objective_fun_reference = ObjectiveFunOne(trajectory_set, species, time_mini, time_maxi, time_unit, time_delta, simulations_maxi = 10, verbose = False, show = False, alpha = 1)
        ...
        # Synthetic Data
        objective_fun = ObjectiveFunOne(None, species, time_mini, time_maxi, time_unit, time_delta, simulations_maxi = 10, verbose = False, show = False, alpha = 1)
