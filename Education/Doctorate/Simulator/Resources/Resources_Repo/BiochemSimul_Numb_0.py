...
class BiochemSimulMuleRapid:
    ...
    def __init__(self, stem, steps, cells, seed = None, verbose = True):
        """
    ...
    def _meth_direct(self):
        if self.verbose:
            ...
            print(fun, '\n\t', arcs)
        @numba.njit
        def __meth_direct__(steps, cells, step_cells, stream_epoch, stream_alps, epoch_mat, pre, state_tor, ran_tor, rates, indices, delta_mat):
    ...
    def meth_direct(self, jump_diffuse_mat = None):
        ...
        # Jump Diffuse [Final]
        #
        self.epoch_mat, self.state_tor = _meth_direct(self.steps, self.cells, step_cells, stream_epoch, stream_alps, epoch_mat, pre, state_tor, ran_tor, rates, indices, delta_mat)
        #
        return self
