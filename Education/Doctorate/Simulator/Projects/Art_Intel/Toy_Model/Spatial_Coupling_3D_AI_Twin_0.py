...
para_set_raw = {'FL': (750, (0, 15000)), 'tau_C': (450, (30, 900)), 'tau_M': (450, (30, 2100)), 'tau_L': (450, (30, 900)), 'tau_S': (450, (30, 2100))}
para_set_mode = 1 # {0, 1}
...
if not sup_comp:
    tasks = 2
    task_simulations = 5
    path = '/media/mars-fias/MARS/MARS_Data_Bank/Art_Intel/Spatial_Coupling_3D_AI_Twin_0/'
...
if sup_comp:
    ...
    path = '/scratch/biochemsim/ramirez/mars_projects/spatial_coupling_art_intel/data_bank/Spatial_Coupling_3D_AI_Twin_0/'
