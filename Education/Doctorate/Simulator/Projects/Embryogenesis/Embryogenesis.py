...
steps = 100000
instate = None
press = BiochemSimulMuse(proto, instate, steps, trajectories, mate, vomer, seed)
press.meth_direct()
...
epoch = 0
vara = [0 for _ in dis]
reps = 10 # How many embryos do you wish?
