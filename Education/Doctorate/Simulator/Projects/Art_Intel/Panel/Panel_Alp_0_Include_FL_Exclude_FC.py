...
data_path = 'Panel_Alp_0_Include_FL_Exclude_FC' # 'Spatial_Coupling_3D_AI_Earth_0_N_G_FL'
acts = [0] # [0, 1, ...]
act = max(acts)
_observe = 0 # {0, 1, ...}
...
para_set_raw = {
    ...
    'N_MRNA': (50, (0, 250)), 'G_MRNA': (50, (0, 250)), 'N': (200, (0, 1000)), 'G': (200, (0, 1000)), 'FL': (1000, (0, 8*1000)),
