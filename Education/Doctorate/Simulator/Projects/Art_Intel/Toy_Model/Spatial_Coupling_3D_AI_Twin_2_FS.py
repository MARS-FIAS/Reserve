...
para_set_raw = {'FL': (750, (0, 15000)), 'td_FS': (7200, (300, 28800)), 'tau_M': (450, (30, 2100)), 'tau_L': (450, (30, 900)), 'tau_S': (450, (30, 2100))}
para_set_mode = 0 # {0, 1}
...
def simulator(parameter_set, parameter_set_true, parameter_set_mode, species = ['N', 'G', 'N_MRNA', 'G_MRNA', 'NP', 'FD', 'EA'], steps = 10000, cells = 3, time_mini = 0, time_maxi = 48, time_unit = 'Hours', time_delta = 0.2, cell_layers = 2, layer_cells = 1, faces = 2*3, seed = None, jump_diffuse_seed = 0, sup_comp = False, verbose = False):
    ...
    rate_mat = instate_rate_mat(stem, cells, parameter_set, parameter_set_true, para_fun, rates_exclude, rho_mat, sigma_vet, blank = False, kd_FS_UP = kd_FS_UP, kd_FS_DO = kd_FS_DO, ksig_C = ksig_C, ksig_M = ksig_M, ksig_L = ksig_L, ksig_S_UP = ksig_S_UP, ksig_S_DO = ksig_S_DO)
...
if not sup_comp:
    tasks = 2
    task_simulations = 5
    path = '/media/mars-fias/MARS/MARS_Data_Bank/Art_Intel/Spatial_Coupling_3D_AI_Twin_2_FS/'
...
if sup_comp:
    ...
    path = '/scratch/biochemsim/ramirez/mars_projects/spatial_coupling_art_intel/data_bank/Spatial_Coupling_3D_AI_Twin_2_FS/'
