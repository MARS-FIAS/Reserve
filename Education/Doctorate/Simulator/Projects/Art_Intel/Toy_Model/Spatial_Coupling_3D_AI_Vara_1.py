#############################################
######## Spatial Coupling 3D AI Vara ########
#############################################

#%%# Catalyzer

sup_comp = False # Super Computer?
vara = 1000 # {500, 750, 1000, 2000, 3000}
...
para_set, para_set_true = make_paras(P_B = (0, vara), exclude = ['Initial_Pat'], verbose = True)
...
if not sup_comp:
    tasks = 2
    task_simulations = 5
    path = '/media/mars-fias/MARS/MARS_Data_Bank/Art_Intel/Spatial_Coupling_3D_AI_Vara_1/'
    tag = f'Loa_Comp_{vara}'
    safe = True
...
if sup_comp:
    ...
    path = '/scratch/biochemsim/ramirez/mars_projects/spatial_coupling_art_intel/data_bank/Spatial_Coupling_3D_AI_Vara_1/'
    tag = f'Sup_Comp_{vara}'
    safe = True
